...
let bankAccount = {
  ...
  withdraw: function(amount){
    if(amount > 0 && amount <= this.balance){
        ...
        //to minimize the concatination :- console.log("Withdrew: " + amount + ". New balance: " + this.balance);
        // we can use template literals by using backticks and ${} to insert variables into the string
